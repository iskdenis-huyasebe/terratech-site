      ...
      <div style={{ maxWidth: '760px', margin: '0 auto', padding: '0 24px', fontFamily: 'sans-serif', color: '#0A1628', lineHeight: '1.7' }}>
        {isRu ? (
          <>
            ...
            <p>Terratech Distribution — компания, осуществляющая поставку профессионального IT-оборудования и промышленной автоматизации. Юридические лица: Terratech UAB (Литва), Terratech S.L. (Испания), Terratech Distribution LLP (Казахстан). Контактный email: <a href="mailto:dkislenko@terradstr.com" style={{ color: '#3E72C7' }}>dkislenko@terradstr.com</a>.</p>
            ...
            <p>Обработка данных осуществляется на основании вашего явного согласия (ст. 6(1)(a) GDPR), которое вы даёте, отмечая чекбокс при отправке формы. Согласие можно отозвать в любой момент, направив письмо на <a href="mailto:dkislenko@terradstr.com" style={{ color: '#3E72C7' }}>dkislenko@terradstr.com</a>.</p>
            ...
            <p>В соответствии с GDPR вы вправе: запросить доступ к своим данным, потребовать их исправления или удаления, ограничить обработку, подать жалобу в надзорный орган. Для реализации прав обращайтесь на <a href="mailto:dkislenko@terradstr.com" style={{ color: '#3E72C7' }}>dkislenko@terradstr.com</a>.</p>
          ...
          <>
            ...
            <p>Terratech Distribution supplies professional IT infrastructure and industrial automation equipment. Legal entities: Terratech UAB (Lithuania), Terratech S.L. (Spain), Terratech Distribution LLP (Kazakhstan). Contact email: <a href="mailto:dkislenko@terradstr.com" style={{ color: '#3E72C7' }}>dkislenko@terradstr.com</a>.</p>
            ...
            <p>Processing is based on your explicit consent (Art. 6(1)(a) GDPR) given by checking the consent box on the contact form. You may withdraw consent at any time by emailing <a href="mailto:dkislenko@terradstr.com" style={{ color: '#3E72C7' }}>dkislenko@terradstr.com</a>.</p>
            ...
            <p>Under GDPR you have the right to access, rectify, or erase your data, restrict processing, and lodge a complaint with a supervisory authority. To exercise your rights, contact us at <a href="mailto:dkislenko@terradstr.com" style={{ color: '#3E72C7' }}>dkislenko@terradstr.com</a>.</p>
